...
- 439027b: Exported search settings no longer carry the index names that identify you
  ...
  index names sit under the same settings, and everyone must publish to their _own_ collection.
