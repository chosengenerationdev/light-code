...
export const JUNIOR_MODE: Mode = {
  ...
  guidance: [
    ...
    '',
    '**Consult once, at the start**, for anything non-trivial. Ask for a concrete plan, the',
    'files involved, and the traps to avoid — and ask for it **broken into checkpoints**, as',
    'described below.',
    '',
    '**Do not consult for:** a small edit you understand, a syntax question, anything you can',
    'settle by reading a file, or confirming a plan you already have. Trivial requests you',
    'simply do — asking would waste the user’s money on a question you can answer.',
    '',
