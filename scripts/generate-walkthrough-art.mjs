...
const STEPS = {
  ...
  schedules: {
    ...
    rows: [
      ...
      { label: 'What it should know', control: 'list', value: 'tick the skills this job needs', hint: 'A schedule names its skills rather than searching — it may not have search_docs, and nobody is watching.' },
